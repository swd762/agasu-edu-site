<?php
namespace G3\L\CacheEngines;
/* @copyright:ChronoEngine.com @license:GPLv2 */defined('_JEXEC') or die('Restricted access');
defined("GCORE_SITE") or die;
class File extends \G3\L\Cache{
	var $dir = null;
	var $expiration = 0;
	var $domain = 'gcore';
	
	function __construct($domain = 'gcore', $params = array('dir' => '', 'expiration' => 0)){
		$this->dir = empty($params['dir']) ? \G3\Globals::get('CACHE_PATH') : $params['dir'];
		$this->expiration = !empty($params['expiration']) ? $params['expiration'] : \G3\L\Config::get('app_cache_expiry', 900);
		$this->domain = $domain;
	}
