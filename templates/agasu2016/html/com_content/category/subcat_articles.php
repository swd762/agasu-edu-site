			...
			<?php foreach ($this->items as $i => $article) : ?>
				...
				<?php endif; ?>
						...
						if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : 
							...
							?>
								<a class="content-material-link news-link" href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($article->slug, $article->catid, $article->language)); ?>">
									<?php 
									if($imgs[2][0]) : ?>
										<div class="news-image-cont"><img class="news-image" src="<?php echo $imgs[2][0];?>"></div>
									<?php else : ?>
										<div class="news-image-cont"><img class="news-image" src="/files/images/64-admin/agasu_logo_foot.png"></div>
									<?php endif;
									echo '<div class="news-content-cont"><span>'.$this->escape($article->title).'</span></div>'; ?>
								</a>
						<?php 
						else : ?>
