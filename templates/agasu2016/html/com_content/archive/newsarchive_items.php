...
<div id="archive-items">
	<?php foreach ($this->items as $i => $item) : ?>
        ...
        <?php 
        //Отображаться будут только материалы заданной категории
        if($item->catid == htmlentities($_REQUEST['id'], ENT_QUOTES))
        { ?>
            <?php $info = $item->params->get('info_block_position', 0); ?>
            <div class="row<?php echo $i % 2; ?> clearfix archive-item <?php echo $i;?>" itemscope itemtype="https://schema.org/Article">
